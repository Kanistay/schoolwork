...
local function updateComponentsVisibility()
    pcall(function()
        ...
        -- Debug amaçlı
        print("KanistayLabel:", KanistayLabel)
        print("ButtonContainer:", ButtonContainer)

        if KanistayLabel and typeof(KanistayLabel) == "Instance" and KanistayLabel.Parent then
            KanistayLabel.Visible = shouldBeVisible
        end

        if ButtonContainer and typeof(ButtonContainer) == "Instance" and ButtonContainer.Parent then
