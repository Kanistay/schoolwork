...
-- ButtonContainer'ın içine örnek bir child ekle (güvenli kontrol ile)
if ButtonContainer then
    ...
    -- ButtonContainer'ın başlangıç görünürlüğünü ayarla
    ButtonContainer.Visible = false
else
    print("ButtonContainer bulunamadı - child eklenemedi")
end
