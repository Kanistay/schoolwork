...
function OrionLib:MakeWindow(WindowConfig)
	...
	-- Kanistay HUB yazısı - menünün dış sol kenarında ve -90 derece döndürülmüş
	local KanistayLabel = Instance.new("TextLabel")
	KanistayLabel.Name = "KanistayLabel"
	KanistayLabel.Size = UDim2.new(0, 24, 1, 0) -- Menüyle aynı yükseklikte, dar bir şerit
	KanistayLabel.Position = UDim2.new(0, -24, 0, 0) -- Menü dışı sol kenar
	KanistayLabel.AnchorPoint = Vector2.new(0, 0) -- Sol üst köşe referans
	...
	KanistayLabel.Rotation = -90 -- Dikey ve okunabilir
