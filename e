...
function OrionLib:MakeWindow(WindowConfig)
			...
			if isTabsVisible then
				...
				if WindowStuff then
					TweenService:Create(WindowStuff, TweenInfo.new(0.3, Enum.EasingStyle.Quad), {
						Size = UDim2.new(0, 150, 1, -50),
						Position = originalStuffPosition -- Orijinal pozisyonu kullan
					}):Play()
	...
	AddConnection(MainWindow:GetPropertyChangedSignal("Size"), function()
		if WindowStuff and MainWindow and MainWindow:FindFirstChild("TopBar") then
			if not Minimized then
				...
				WindowStuff.Position = originalStuffPosition
	...
	-- Orijinal WindowStuff pozisyonu ve boyutunu saklayacak değişkenler
	local originalStuffPosition = UDim2.new(0, 0, 0, 50)
	local originalStuffSize = UDim2.new(0, 150, 1, -50)
	...
	local function FixWindowStuffPosition()
		if WindowStuff then
			if Minimized then
				...
				WindowStuff.Position = originalStuffPosition
				WindowStuff.Size = originalStuffSize
			end
		end
	end
