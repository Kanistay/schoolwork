...
function OrionLib:MakeWindow(WindowConfig)
	...
	AddConnection(MinimizeBtn.MouseButton1Up, function()
		if Minimized then
			...
			if WindowStuff then
				WindowStuff.Position = UDim2.new(0, 0, 0, -40) -- -50 yerine -40 kullanarak taşmayı önle
			end
	...
	ButtonContainer.Size = UDim2.new(0, 35, 0, 35) -- Biraz daha büyük boyut
	...
	PlusBtn.TextSize = 20 -- Daha küçük yazı
