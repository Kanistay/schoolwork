...
local function setupOrionVisibilitySync()
    ...
    -- Orion'un yüklenmesini bekle
    local orionScreenGui = CoreGui:WaitForChild("Orion")
    
    -- Orion yüklendikten sonra 3 saniye bekle (öğelerin tam yüklenmesi için)
    wait(3)
    ...
    local function syncVisibility()
        ...
        print("- KanistayLabel.Visible = " .. tostring(isVisible))
        print("- ButtonContainer.Visible = " .. tostring(isVisible))
    end
    ...
    print("Hedef Frame: " .. targetFrame.Name)
    print("SnowContainer Path: " .. targetFrame.Name .. ".SnowContainer")
    
    -- Connection'ı geri döndür
    return connection
end
